...
hypre_int main(hypre_int argc, char *argv[])
{
   ...
   cycle_type = 13;
   ams_rlx_type = 2;  /* 1 - l1-scaled JAC; 3 - kaczmarz; 2/4: Hybrid GS; */
   ams_rlx_sweeps = 1;
   ams_rlx_weight = 1.0;
   ams_rlx_omega = 1.0;
   ...
   /* Parse command line */
   {
      ...
      while (arg_index < argc)
      {
         ...
         else if (strcmp(argv[arg_index], "-bmaxit") == 0)
         {
            arg_index++;
   ...
   /* FGMRES solvers */
   else if (solver_id == 21 || solver_id == 23 || solver_id == 24)
   {
      /* Start timing */
      if (solver_id == 21)
      {
